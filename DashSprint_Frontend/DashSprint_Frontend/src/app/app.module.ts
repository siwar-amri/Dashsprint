...
import { SignupComponent } from './demo/pages/authentication/register/register.component';
...
@NgModule({
  ...
  imports: [BrowserModule, AppRoutingModule, SharedModule, BrowserAnimationsModule,HttpClientModule,FormsModule,NgApexchartsModule ],
